...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager){
        ...
        filterChainDefinitionMap.put("/user/login", "anon");            //匿名（不需要登录）
        filterChainDefinitionMap.put("/user/logout", "logout");         //如果访问/user/logout，将完成shiro退出功能（SecurityUtils.getSubject().logout();）
        ...
        filterChainDefinitionMap.put("/pages/base/courier", "perms[courier:list]"); //该路径必须具有指定权限
        filterChainDefinitionMap.put("/pages/base/area", "roles[base]");            //该路径必须具有指定角色
